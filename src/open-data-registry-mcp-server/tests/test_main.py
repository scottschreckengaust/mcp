...
from awslabs.open_data_registry_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.open_data_registry_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.open-data-registry-mcp-server'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.open_data_registry_mcp_server import server
