...
"""Tests for the Open Data Registry MCP Server."""

import pytest
from awslabs.open_data_registry_mcp_server.server import example_tool
from awslabs.open_data_registry_mcp_server.server import math_tool

@pytest.mark.asyncio
async def test_example_tool():
    # Arrange
    test_query = "test query"
    expected_project_name = "awslabs Open Data Registry MCP Server"
